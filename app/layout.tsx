          ...
          <div style={{ maxWidth: '1224px', margin: '0 auto', padding: '0 20px' }}>
            <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 0' }}>
              ...
              <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                ...
                <a href="/square-products" style={{ padding: '11px 16px', borderRadius: '999px', border: '1px solid var(--line)', background: 'linear-gradient(135deg, #00B9A0, #5ED0C0)', color: 'white', boxShadow: '0 6px 18px rgba(0,185,160,.3)', textDecoration: 'none', fontWeight: 600 }}>🛍️ Square Catalog</a>
